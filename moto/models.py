...
class Moto(models.Model):
    ...
    motif_reparation = models.CharField(max_length=500,blank=True)
    commercial = models.CharField(max_length=500,blank=True)
    volume_moteur = models.CharField(max_length=500,blank=True)
    ...
    montant_lettre = models.CharField(max_length=500,blank=True)
