...
def index(request):
    ...
    return render(request, 'moto/index.html', {'motos': motos,'count':count,'pageTitle':pageTitle,'lastID':lastID,'lastFacture':lastFacture,'lastBL':lastBL})
...
def chart(request):
    if request.is_ajax and request.method == 'GET':
        ...
        datatrimestre = {}
        trimestrename = ["Janvier-Fevrier-Mars","Avril-Mai-Juin","Juillet-Aout-Septembre","Octobre-Novembre-Decembre"]
